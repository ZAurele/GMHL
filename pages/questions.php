...
if ($valid_q) {
    ...
    $sql = "SELECT * FROM questionnaires where user_id = '".$USER_ID."' and category = '".$category."' and type = '".$type."' and number = ".$SELECTED_NB[$category]." and version = ".$SELECTED_VERSION[$category]." order by id DESC";
